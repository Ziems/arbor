...
class GRPOManager(BaseManager):
    ...
    def initialize(
        ...
        try:
            ...
            raise TrainingError(
                "Failed to initialize GRPO job", request=payload, cause=str(exc)
            ) from exc
    ...
    def route_grpo_step(self, request: GRPOStepRequest):
        ...
        try:
            ...
            raise TrainingError("GRPO step failed", cause=str(exc), **context) from exc
    ...
    def route_grpo_checkpoint(self, request: GRPOCheckpointRequest) -> GRPOStatus:
        ...
        try:
            ...
            raise TrainingError(
                "GRPO checkpoint failed", cause=str(exc), **context
            ) from exc
    ...
    def cancel(self, job_id: str) -> GRPOStatus:
        ...
        try:
            ...
            raise TrainingError(
                "Failed to cancel GRPO job", job_id=job_id, cause=str(exc)
            ) from exc
